<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PrintSlip.aspx.vb" Inherits="PrintSlip" %>
                    ...
                    <td class="fontcertmain">
                        ...
                        <tr>
                            <td class="auto-style5" style="font-weight: bold">
                                TRANSACTION TYPE:</td>
                            <td class="fontcertmain">
                                <asp:Label ID="lblTranstype" Width="400px" Style="word-wrap: normal; word-break: break-all;" runat="server" Text=""></asp:Label></td>
                        </tr>
                        <tr>
                            <td class="auto-style5" style="font-weight: bold">
                                OG FARMER:</td>
                            <td class="fontcertmain">
                                <asp:Label ID="lblOG" Width="400px" Style="word-wrap: normal; word-break: break-all;" runat="server" Text=""></asp:Label></td>
                        </tr>
                        <tr>
