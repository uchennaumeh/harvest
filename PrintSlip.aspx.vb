...
Partial Class PrintSlip
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Try
                Dim param() As SqlParameter = {New SqlParameter("@TransCode", Session("TransCode"))}
            ...
            Catch ex As Exception
                lblError.Text = "An Exception Occurred. Please Try again or use the REPRINT-SLIP Page"
