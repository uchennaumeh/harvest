<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="DailyTrans.aspx.vb" Inherits="DailyTrans" %>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table width="100%">
                            <tr>
                                <td align="left">
                                    <h1>
                                        <asp:Label ID="Label1" runat="server" Text="Daily Transactions Report"></asp:Label></h1>
                                </td>
                                <td></td>
                                <td align="right">
                    ...
                    <div class="panel-bodyUche">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtFrom" runat="server" class="form-control input-md" TextMode="Date"></asp:TextBox>
                            ...
                            <asp:Button ID="btnSubmit" runat="server" Text="SPOOL REPORT" class="btn btn-danger btn-lg pull-left" />
                        </div>

                        <rsweb:ReportViewer ID="ReportViewer1" runat="server" BackColor="" Visible="false" Height="100%" Width="100%" ClientIDMode="AutoID" HighlightBackgroundColor="" InternalBorderColor="204, 204, 204" InternalBorderStyle="Solid" InternalBorderWidth="1px" LinkActiveColor="" LinkActiveHoverColor="" LinkDisabledColor="" PrimaryButtonBackgroundColor="" PrimaryButtonForegroundColor="" PrimaryButtonHoverBackgroundColor="" PrimaryButtonHoverForegroundColor="" SecondaryButtonBackgroundColor="" SecondaryButtonForegroundColor="" SecondaryButtonHoverBackgroundColor="" SecondaryButtonHoverForegroundColor="" SplitterBackColor="" ToolbarDividerColor="" ToolbarForegroundColor="" ToolbarForegroundDisabledColor="" ToolbarHoverBackgroundColor="" ToolbarHoverForegroundColor="" ToolBarItemBorderColor="" ToolBarItemBorderStyle="Solid" ToolBarItemBorderWidth="1px" ToolBarItemHoverBackColor="" ToolBarItemPressedBorderColor="51, 102, 153" ToolBarItemPressedBorderStyle="Solid" ToolBarItemPressedBorderWidth="1px" ToolBarItemPressedHoverBackColor="153, 187, 226">
                            <LocalReport ReportPath="DailyTrans.rdlc">
                                <DataSources>
                                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="DataSetDailyTrans" />
                                </DataSources>
                            </LocalReport>
                        </rsweb:ReportViewer>
                        ...
                        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="caneWeighDailyTransDataSetTableAdapters.caneWeigh_DailyTrans_FetchTableAdapter"></asp:ObjectDataSource>
