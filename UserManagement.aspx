<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="UserManagement.aspx.vb" Inherits="UserManagement" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <asp:Label ID="Label2" runat="server" Text="USER CREATION" Font-Bold="True" ForeColor="#000066"></asp:Label></h3>
                    ...
                    <div class="panel-body">
                        <table width="100%">
                            <tr>
                                <td align="left">
                                    <h1>
                                        <asp:Label ID="Label1" runat="server" Text="New User Registration" ForeColor=""></asp:Label></h1>
                                </td>
                                <td></td>
                                <td align="right">
                    ...
                    <div class="panel-footer">
                        <asp:Button ID="btnLogin" runat="server" Text="CREATE USER" class="btn btn-primary btn-lg pull-right" />
    ...
    <table align="center" cellpadding="2" style="width: 70%">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TextBox7" Visible="false" runat="server"></asp:TextBox></td>
            <td>
