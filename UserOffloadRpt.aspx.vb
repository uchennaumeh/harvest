...
Partial Class UserOffloadRpt
    ...
    Protected Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        Try
            ...
            thisDataSet = SqlHelper.ExecuteDataset(Connstring, CommandType.StoredProcedure, "caneWeigh_TimeOut_user_range_Fetch", params)

            Dim ds As ReportDataSource = New ReportDataSource("DataSetReportOffLoad", thisDataSet.Tables(0))
