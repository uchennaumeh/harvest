...
Partial Class CreateEstate
    ...
    Protected Sub loadGridB()
        ...
        Dim cmd As New SqlCommand("caneWeigh_EstateGrid_Fetch", con)
    ...
    Protected Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        Try
            Dim params3() As SqlParameter = {New SqlParameter("@EstateName", txtEstateName.Text)}

            SqlHelper.ExecuteDataset(Connstring, CommandType.StoredProcedure, "[dbo].[caneWeigh_Estate_insert]", params3)
            ClientScript.RegisterStartupScript(Me.GetType(), "Success", "<script type='text/javascript'>alert('ESTATE Successfully Created');window.location='CreateEstate.aspx';</script>'")
