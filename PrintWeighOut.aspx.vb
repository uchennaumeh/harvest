    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                Dim param() As SqlParameter = {New SqlParameter("@TransCode", Session("TransCoder"))}
                ...
                lblCycle.Text = retValue1.Table.Rows(0).Item("Cycle").ToString.ToUpper
        ...
        Catch ex As Exception
            lblError.Text = "An Exception Occurec, please try again or visit the REPRINT-SLIP page"
