<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RePrintSlip.aspx.vb" Inherits="RePrintSlip" %>
                ...
                <td class="auto-style3" border="1">      
                  ...
                  <tr>
                    ...
                    <td class="fontcertmain">
                        ...
                        <tr>
                    <td class="auto-style5"  border="1"><strong>SPACING:</strong></td>
                    <td class="fontcertmain">
                        <asp:Label ID="lblSpacing" Width="400px" Style="word-wrap: normal; word-break: break-all;" runat="server"></asp:Label>
                      </td>
                  </tr>
                        <tr>
                    <td class="auto-style5"  border="1"><strong>CROP CYCLE:</strong></td>
                    <td class="fontcertmain">
                        <asp:Label ID="lblCycle" Width="400px" Style="word-wrap: normal; word-break: break-all;" runat="server"></asp:Label>
                      </td>
                  </tr>
                        <tr>
                    <td class="auto-style5"  border="1"><strong>VARIETY:</strong></td>
                    <td class="fontcertmain">
                        <asp:Label ID="lblVariety" Width="400px" Style="word-wrap: normal; word-break: break-all;" runat="server"></asp:Label>
                      </td>
                            </tr>
                            <tr>
                    <td class="auto-style5"  border="1"><strong>OG FARMER:</strong></td>
                    <td class="fontcertmain">
                        <asp:Label ID="lblOG" Width="400px" Style="word-wrap: normal; word-break: break-all;" runat="server"></asp:Label>
                      </td>
                  </tr>
                        <tr>
                    <td class="auto-style5"  border="1"><strong>TRANSACTION TYPE:</strong></td>
                    <td class="fontcertmain">
                        <asp:Label ID="lblTransType" Width="400px" Style="word-wrap: normal; word-break: break-all;" runat="server"></asp:Label>
                      </td>
                  </tr>
                  <tr>
