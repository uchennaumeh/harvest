...
Partial Class UserTicketRpt
    ...
    Protected Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        thisDataSet = SqlHelper.ExecuteDataset(Connstring, CommandType.StoredProcedure, "caneWeigh_TimeIn_user_range_Fetch", params)

            Dim ds As ReportDataSource = New ReportDataSource("DataSetTicketing", thisDataSet.Tables(0))
