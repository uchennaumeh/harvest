<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="RePrintTicket.aspx.vb" Inherits="RePrintTicket" %>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <asp:Label ID="Label2" runat="server" Text="TICKET" Font-Bold="True" ForeColor="#000066"></asp:Label></h3>
                    ...
                    <div class="panel-body">
                        <table width="100%">
                            <tr>
                                <td align="left">
                                    <h1>
                                        <asp:Label ID="Label1" runat="server" Text="Re-Print Tickets" ForeColor=""></asp:Label></h1>
                                </td>
                                <td></td>
                                <td align="right">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:HyperLinkField DataNavigateUrlFields="Code" DataNavigateUrlFormatString="RePrintSlip.aspx?Code={0}" DataTextField="Code" DataTextFormatString="Print Ticket For for {0}" HeaderText="PRINT TICKET" />
