<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EnableUser.aspx.vb" Inherits="EnableUser" %>
                    ...
                    <div class="panel-body">
                        <table width="100%">
                            <tr>
                                <td align="left">
                                    <h1>
                                        <asp:Label ID="Label1" runat="server" Text="Enable User"></asp:Label></h1>
                                </td>
                                <td></td>
                                <td align="right">
             ...
             <div class="col-md-6">
                                <table>
                                    <tr>
                                     ...
                                     <tr>
                                        <td>
                                            <asp:Button ID="btnEnable" runat="server" Text="ENABLE USER" class="btn btn-danger btn-lg pull-left" />
                                        </td>
                                        <td>
