...
Partial Class CreateZone
    ...
    Protected Sub loadGridB()
        ...
        Dim cmd As New SqlCommand("caneWeigh_ZoneGrid_Fetch", con)
    ...
    Protected Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        Try
            Dim params3() As SqlParameter = {New SqlParameter("@ZoneName", txtZoneName.Text),
                New SqlParameter("@ZoneNumber", txtZoneNumber.Text)}

            SqlHelper.ExecuteDataset(Connstring, CommandType.StoredProcedure, "[dbo].[caneWeigh_Zone_insert]", params3)
            ClientScript.RegisterStartupScript(Me.GetType(), "Success", "<script type='text/javascript'>alert('ZONE Successfully Created');window.location='CreateZone.aspx';</script>'")
