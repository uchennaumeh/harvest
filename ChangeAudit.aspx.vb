...
Partial Class ChangeAudit
    ...
    Protected Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        Try
            ...
            Dim params() As SqlParameter = {New SqlParameter("@DateAsAt", txtFrom.Text)}
            thisDataSet = SqlHelper.ExecuteDataset(Connstring, CommandType.StoredProcedure, "caneWeigh_ChangeAudit_Report", params)

            Dim ds As ReportDataSource = New ReportDataSource("DataSetAuditChange", thisDataSet.Tables(0))
